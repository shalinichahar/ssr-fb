...
const CreditCardDetailsTable = ({ account }) => {
  return (
    <div className="flex gap-9 justify-center m-2">
      ...
      <div className="rounded-xl border border-solid border-tableBorder bg-[#f2f8ff] shadow-lg overflow-hidden">
        <table className="w-full border-collapse text-[11.5px]">
          <tbody>
        <tr className="bg-white">
                <td className="px-4 py-3 text-fb-primary">Maximum Utilization</td>
              ...
              <tr className="bg-subtle">
                <td className="px-4 py-3 text-fb-primary">Credit Limit</td>
                <td className="px-4 py-3 font-bold">{currencyFormatToINR(account?.Credit_Limit_Amount) || '-'}</td>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-3 font-bold">{account?.Type_of_Collateral || '-'}</td>
              </tr>
              <tr className="bg-subtle">
