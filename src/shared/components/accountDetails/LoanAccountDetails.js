...
import { transformAccountHistory, AccountHeader, AccountDetailsSection, PaymentStatusIcons,  PaymentHistoryTable} from '../../helpers/AccountDetails.Helpers';
import LoanDetailsTable from './LoanDetailsTable';

const LoanAccountDetails = ({ account}) => {
  ...
  return (
    <div className="rounded-xl border border-solid border-tableBorder shadow-lg overflow-hidden font-dm-sans text-center pb-4">
      <div className="w-full text-left border-collapse">
        ...
        <LoanDetailsTable account={account} />
